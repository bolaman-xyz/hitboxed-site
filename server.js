...
app.get('/api/my-products', authMiddleware, async (req, res) => {
    ...
    try {
        // Search ALL invoices by email (paginated â€” finds older customers too)
...
app.listen(PORT, '0.0.0.0', () => {
    ...
    const onVolume = process.env.DATA_DIR ? 'set' : 'NOT SET (data will be wiped on redeploy â€” set DATA_DIR + attach a volume)';
